...
@Composable
fun AllArtistsActivity(navController: NavController, innerPadding: PaddingValues) {
    ...
    Column (
        ...
        Text(text = "Artists", Modifier.padding(start = 20.dp), fontWeight = FontWeight.Bold, fontSize = 35.sp)
        LazyColumn(
            ...
            items(artistList.size) { index ->
                Card (onClick = {
                    navController.navigate("artistactivity/${artistList[index].getId()}")
                },
                    modifier = Modifier
                        .fillMaxWidth()
                        .padding(10.dp),
                    ...
                    Row (
                        ...
                        Box (Modifier
                            ...
                            Image(painter = painterResource(
                                id = if(artistList[index].getName().contains("Jonas")) {
                                    R.drawable.jonasartistphoto
                                }
                                else if (artistList[index].getName().contains("Muse")) {
                        ...
                        Column (Modifier.padding(start = 12.dp)){
                            Text(
                                artistList[index].getName(), Modifier.padding(start = 12.dp)
                            )
                        }
                    }
                }
